        ...
        match question:
            ...
            case 'birth_year':
                ...
                if intValue < minimum_year or intValue > maximum_year:
                    ...
                    return 2;
            case _: 
                #If the question is not a question that queries for an integer value then it's an invalid response
...
#Initialize function
def initialize():
    askQuestions() #Fire the askQuestions function
    #Suspended until askQuestions function is finished
    validateBirth() #Check if birthday inputted is valid
    voterEligibilityCheck() #Check if the user is eligible to vote
